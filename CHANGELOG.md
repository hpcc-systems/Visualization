...
* bump versions (security) ([#4518](https://github.com/hpcc-systems/Visualization/issues/4518)) ([ec5387b](https://github.com/hpcc-systems/Visualization/commit/ec5387bf8b52e9ec97061a3fdfefc5cecc5ddb92)), closes [#4516](https://github.com/hpcc-systems/Visualization/issues/4516)
...
* Add "LayoutChanged" event to DockPanel ([d74ebba](https://github.com/hpcc-systems/Visualization/commit/d74ebba026dc259e758fc596cc8e603dce35ed9d))
...
* Add "option" get/set to Editor ([3073cec](https://github.com/hpcc-systems/Visualization/commit/3073ceca700025fcb37df8016107b09be061b918))
...
* Add accumulated stats to Query Metrics ([4031c3f](https://github.com/hpcc-systems/Visualization/commit/4031c3fdab6b3d1c56a95ae989141b9c41744ca5))
...
* Add better error handling for graphviz webworker ([83dbf7b](https://github.com/hpcc-systems/Visualization/commit/83dbf7bd00da10a669a0b4e68b313a367e864ce1))
...
* Add extra formatting to WUDetails ([727ecc6](https://github.com/hpcc-systems/Visualization/commit/727ecc68afb7f81a20c80a8ffe08517ab778129f))
...
* Add padding property to DockPanel.addWidget ([de64643](https://github.com/hpcc-systems/Visualization/commit/de646434b6f1d56f52ef4c0f30725a1eabb86c0a))
...
* Add Protect & Unprotect functions to Visualization WU Class ([16ee388](https://github.com/hpcc-systems/Visualization/commit/16ee388f89d627a22b7bce5ab6f9e560bed6ac84))
...
* bump WsDFU to latest to include support for ExtendedIndexInfo ([f74f678](https://github.com/hpcc-systems/Visualization/commit/f74f6785edcc0e8d761724a63a260a909c9a6a4f))
...
* **comms:** add a States enum to FileSpray service ([68e302f](https://github.com/hpcc-systems/Visualization/commit/68e302f22ee45c8a92747add841854fd34daa15b))
...
* **comms:** Add WU compile cost ([e1c816d](https://github.com/hpcc-systems/Visualization/commit/e1c816d0ebe4157cd436a79e918774f884e14f6e))
...
* **comms:** allow the WU refresh function to accept optional request ([284e94c](https://github.com/hpcc-systems/Visualization/commit/284e94cb6ee811aeb7d77c9fed44af21b853e476))
...
* **comms:** convert wsTopology to use service generated from wsdl ([a5815ed](https://github.com/hpcc-systems/Visualization/commit/a5815edc1ebbd21505901fada5cfb63dc126abb1))
...
* **comms:** update, abort, delete methods for dfuWorkunit ([3907a58](https://github.com/hpcc-systems/Visualization/commit/3907a586f980646756e24435ab9bc2af931680e4))
...
* Parse the DefinitionList at source ([95628fc](https://github.com/hpcc-systems/Visualization/commit/95628fce57aebbc084160ae0f6a9405cebae8e6c))
...
* Add guard against unknown event source ([3f3981c](https://github.com/hpcc-systems/Visualization/commit/3f3981cc9270e1a2a59ad5ae7ae1161ffe18cb70))
...
* **comms:** dgrid-shim gridHelper reset huge total to sensible number ([3c2c9d8](https://github.com/hpcc-systems/Visualization/commit/3c2c9d8e74c2bcd8bf1ad0557a3a935f8c430348))
...
* **comms:** extend FileSpray.DFUWUFile to change reponse type to text ([e4c6aaa](https://github.com/hpcc-systems/Visualization/commit/e4c6aaa6c32423a212a17ac2102f78107ea84026))
...
* **comms:** GetLogsEx still using hardcoded ...KnownColumns maps ([a6b710d](https://github.com/hpcc-systems/Visualization/commit/a6b710da482b9d95f31dd4fef409b7c7a6f3fa82))
...
* **comms:** incorrect default for line count returned by GetLogs ([8fc4540](https://github.com/hpcc-systems/Visualization/commit/8fc4540cecae3d5b487fa36f159e8229c28303fa))
...
* **comms:** separate Logaccess StartDate & EndDate request filters ([ea77188](https://github.com/hpcc-systems/Visualization/commit/ea77188354d71c4febbe557b1f028f070eaa0efb))
...
* **comms:** use RemoteLogManagerType to build GetLogs request ([611699d](https://github.com/hpcc-systems/Visualization/commit/611699d0a2a79a182f1e0af97baa7def70287d2d))
* **comms:** wsLogaccess GetLogs fix an incorrect boolean operator ([49074e8](https://github.com/hpcc-systems/Visualization/commit/49074e87ce2adc9fa8ec732a569fadc92bac9cb3))
...
* **comms:** WsLogaccess incorrect abbrev for TargetAudience value ([7ba0551](https://github.com/hpcc-systems/Visualization/commit/7ba0551161270b224b7a542d5e70ff17f0c68746))
...
* **comms:** wslogaccess, do not use binaryFilter if not necessary ([11514d9](https://github.com/hpcc-systems/Visualization/commit/11514d9c5fb267c0b7d5892c2b40219b3fe372e5))
...
* Doc generation failing ([f8c1fe7](https://github.com/hpcc-systems/Visualization/commit/f8c1fe729a6f46eb485b154e87513d2a619396c3))
...
* Event.path is non-standard ([3919016](https://github.com/hpcc-systems/Visualization/commit/3919016b067421cd7021553666612dbccc82f137))
...
* Exclude undici from bundles ([90c88e0](https://github.com/hpcc-systems/Visualization/commit/90c88e03c025bc65f3b961cc2d4e03f36e956924))
...
* **graph:** Tweak previous refactor to ensure backward compatibility ([e40e1a0](https://github.com/hpcc-systems/Visualization/commit/e40e1a0ddf472ff85a93a2c30b435182f5316ac1))
...
* grouped properties had "any" type. ([9b7a2ab](https://github.com/hpcc-systems/Visualization/commit/9b7a2ab8fb73367a5cdf64ea2d9a174f3402a6fa))
...
* **html/common:** correct BreakdownTable tooltip height calculation ([c587154](https://github.com/hpcc-systems/Visualization/commit/c5871545ec4daf0ee56d8b62ff61050345c39154))
...
* isWUComplete fails for compile + Attach ([08076c2](https://github.com/hpcc-systems/Visualization/commit/08076c26434f5db4a061f0c9c111f575e8f062e6))
...
* Potential prototype pollution ([6b56329](https://github.com/hpcc-systems/Visualization/commit/6b56329c0de32ce1d979634a00002257878034b3))
...
* Query fails fetching schemas ([4733dca](https://github.com/hpcc-systems/Visualization/commit/4733dca77ac5918e986e1c4567e29f23a3fac5b6))
...
* Refresh does not load details ([fff33a2](https://github.com/hpcc-systems/Visualization/commit/fff33a21815029cdb4b3884e8daca3094fb0b9f4))
...
* Switch to working cors proxy ([4b0b11f](https://github.com/hpcc-systems/Visualization/commit/4b0b11f96ffc0551f40c8497bb74b88702914961))
...
* Switch to wsdl generated WsSMC ([20ee0d2](https://github.com/hpcc-systems/Visualization/commit/20ee0d22344c9e3f3e9b3dd198de3398ad3149c0))
...
* Tweak grouped label ([cd2cf31](https://github.com/hpcc-systems/Visualization/commit/cd2cf314abca340286e1a6c4117b590763fce496))
...
* Undici change broke tests ([95ba6c6](https://github.com/hpcc-systems/Visualization/commit/95ba6c6bd196d9cc1d5f5086d8ff9b5cfab454f9))
