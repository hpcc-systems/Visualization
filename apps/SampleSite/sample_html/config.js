...
case "cdn.rawgit.com":
    require.config({
        paths: {
            ...
            "amcharts": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/amcharts",
            "amcharts.funnel": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/funnel",
            "amcharts.gauge": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/gauge",
            "amcharts.pie": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/pie",
            "amcharts.radar": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/radar",
            "amcharts.serial": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/serial",
            "amcharts.xy": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/xy",
            "amcharts.plugins.responsive": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/plugins/responsive/responsive",
            "amcharts.plugins.dataloader": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/plugins/dataloader",
            "amchartsImg": "//" + window.location.hostname + "/arturgspb/bower-amcharts/v3.15.2/dist/amcharts/images/",
