require.config({
    ...
    paths: {
        ...
        'amcharts': ["http://rawgit.com/arturgspb/bower-amcharts/v3.13.3/dist/amcharts/amcharts", "../bower_components/amcharts/dist/amcharts/amcharts"],
        'amcharts/funnel': ["http://rawgit.com/arturgspb/bower-amcharts/v3.13.3/dist/amcharts/funnel", "../bower_components/amcharts/dist/amcharts/funnel"],
        'amcharts/gauge': ["http://rawgit.com/arturgspb/bower-amcharts/v3.13.3/dist/amcharts/gauge", "../bower_components/amcharts/dist/amcharts/gauge"],
        'amcharts/pie': ["http://rawgit.com/arturgspb/bower-amcharts/v3.13.3/dist/amcharts/pie", "../bower_components/amcharts/dist/amcharts/pie"],
        'amcharts/radar': ["http://rawgit.com/arturgspb/bower-amcharts/v3.13.3/dist/amcharts/radar", "../bower_components/amcharts/dist/amcharts/radar"],
        'amcharts/serial': ["http://rawgit.com/arturgspb/bower-amcharts/v3.13.3/dist/amcharts/serial", "../bower_components/amcharts/dist/amcharts/serial"],
        'amcharts/xy': ["http://rawgit.com/arturgspb/bower-amcharts/v3.13.3/dist/amcharts/xy", "../bower_components/amcharts/dist/amcharts/xy"],
    },
    shim: {
        'amcharts/funnel': {
            deps: [ 'amcharts' ],
