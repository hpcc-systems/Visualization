    ...
    var amchartFactory = {
        Gantt: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Gantt"], function (DataFactory, Gantt) {
                    callback(new Gantt()
        ...
        Combo: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Combo"], function (DataFactory, Combo) {
                    callback(new Combo()
        ...
        Bar: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Bar"], function (DataFactory, Bar) {
                    var bar = new Bar()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                        ;
        ...
        Column: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Column"], function (DataFactory, Column) {
                    var col = new Column()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                        ;
        ...
        Scatter: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Scatter"], function (DataFactory, Scatter) {
        ...
        Line: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Line"], function (DataFactory, Line) {
                    callback(new Line()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                    );
        ...
        Area: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Area"], function (DataFactory, Area) {
                    callback(new Area()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                    );
        ...
        Pie: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Pie"], function (DataFactory, Pie) {
                    callback(new Pie()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                    );
        ...
        Gauge: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Gauge"], function (DataFactory, Gauge) {
                    callback(new Gauge()
        ...
        Pyramid: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Pyramid"], function (DataFactory, Pyramid) {
        ...
        Polar: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Polar"], function (DataFactory, Polar) {
                    callback(new Polar()
        ...
        Funnel: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/amchart/Funnel"], function (DataFactory, Funnel) {
                    callback(new Funnel()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                    );
