    ...
    var mapFactory = {
        Deck: {
            ...
            Polygons: function (callback) {
                legacyRequire(["test/DataFactory", "src/map-deck/Polygons"], function (DataFactory, Polygons) {
                    callback(new Polygons()
                        .columns(["label", "polys", "weight"])
                        .data(DataFactory.Sample.Poly)
                        .polygonColumn("polys")
                        .weightColumn("weight")
                    );
                });
