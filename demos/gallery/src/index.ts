...
import { sampleFiles, sampleFolders, sampleIdx } from "./samples.ts";
...
export class App extends HTMLWidget {
    ...
    update(domNode, element) {
        ...
        if (this.renderCount() === 0) {
            const defaultRow = sampleFolders.filter(row => row.path.indexOf(this.default()) === 0)[0] || sampleFolders[0];
...
export interface App {
    default(): string;
    default(_: string): this;
}

App.prototype.publish("default", "", "string", "Default", null, {});
