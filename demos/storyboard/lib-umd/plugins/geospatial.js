...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@hpcc-js/map", "./util"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var hpccMap = require("@hpcc-js/map");
    ...
    function pinsFactory(type, prefix) {
        return function (props) {
            ...
            return __asyncGenerator(this, arguments, function () {
                var Widget, columns, cp, _div, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            Widget = hpccMap[prefix][type];
                            columns = ["lat", "lng", "faChar", "color", "popup"];
                            cp = new Widget()
                                .columns(columns)
    ...
    for (var key in Leaflet) {
        exports.geospatial[key] = pinsFactory(Leaflet[key], "Leaflet");
    }
});
