...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@hpcc-js/comms"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var commsMod = require("@hpcc-js/comms");
    function roxie(url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, {
                        url: url,
                        query: function (querySet, queryID) { return service(commsMod.Query.attach({ baseUrl: url }, querySet, queryID)); }
                    }];
            });
        });
    }
