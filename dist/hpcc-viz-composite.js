...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('composite/Dermatology.js',["../layout/Border", "../layout/Toolbar", "../layout/Grid", "../form/OnOff", "../form/Button", "../common/Icon", "../other/PropertyEditor", "css!./Dermatology"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('composite/MegaChart.js',["d3","../layout/Border", "../chart/MultiChart", "../common/Text", "../other/Legend", "../layout/Toolbar", "../form/Select", "../form/Button", "../form/Input", "../common/Utility", "../other/Html", "css!./MegaChart"], factory);
    } else {
