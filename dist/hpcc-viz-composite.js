...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('composite/MegaChart.js',["d3","../layout/Border", "../chart/MultiChart", "../common/Text", "../other/Legend", "../layout/Toolbar", "../form/Select", "../form/Button", "../form/Input", "../common/Utility", "css!./MegaChart"], factory);
    } else {
