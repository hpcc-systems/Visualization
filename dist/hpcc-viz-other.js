...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('other/Table.js',["d3", "../common/HTMLWidget","./Paginator", "./Bag", "css!./Table"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('other/Legend.js',["d3", "./Table", "../chart/MultiChart", "../layout/Grid", "css!./Legend"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('other/PropertyEditor',["d3", "../common/Widget", "../common/HTMLWidget", "./Persist", "../layout/Grid", "css!./PropertyEditor"], factory);
    } else {
