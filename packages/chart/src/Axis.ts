...
export class Axis extends SVGWidget {
    ...
    updateScale(): this {
        switch (this.type()) {
            case "ordinal":
                this.d3Scale = d3ScaleBand().padding(this.ordinalPaddingOuter());
...
Axis.prototype.publish("ordinalPaddingOuter", 0.1, "number", "Determines the ratio of the range that is reserved for blank space before the first band, after the last band and between bands");
