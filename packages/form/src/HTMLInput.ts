...
HTMLInput.prototype._class += " form_HTMLInput";
...
HTMLInput.prototype.publish("minWidth", 50, "number", "Minimum width of the input (pixels)");
HTMLInput.prototype.publish("minHeight", 24, "number", "Minimum height of the input (pixels)");
HTMLInput.prototype.publish("fontSize", 16, "number", "Font size for the input (pixels)");
