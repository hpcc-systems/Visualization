...
export interface TreeMap {
    headerColor(): string;
    headerColor(_: string): this;
    headerHeight(): number;
    headerHeight(_: number): this;
    headerHighlightColor(): string;
    headerHighlightColor(_: string): this;
    hintOpacity(): number;
    hintOpacity(_: number): this;
    maxColor(): string;
    maxColor(_: string): this;
    maxDepth(): number;
    maxDepth(_: number): this;
    maxHighlightColor(): string;
    maxHighlightColor(_: string): this;
    maxPostDepth(): number;
    maxPostDepth(_: number): this;
    maxColorValue(): number;
    maxColorValue(_: number): this;
    midColor(): string;
    midColor(_: string): this;
    midHighlightColor(): string;
    midHighlightColor(_: string): this;
    minColor(): string;
    minColor(_: string): this;
    minHighlightColor(): string;
    minHighlightColor(_: string): this;
    minColorValue(): number;
    minColorValue(_: number): this;
    noColor(): string;
    noColor(_: string): this;
    noHighlightColor(): string;
    noHighlightColor(_: string): this;
    showScale(): boolean;
    showScale(_: boolean): this;
    showTooltips(): boolean;
    showTooltips(_: boolean): this;
    useWeightedAverageForAggregation(): boolean;
    useWeightedAverageForAggregation(_: boolean): this;
}
