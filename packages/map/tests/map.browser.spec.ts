...
import { topoJsonFolder, CanvasPinLayer, CanvasPins, Choropleth, ChoroplethContinents, ChoroplethCounties, ChoroplethCountries, ChoroplethStates, GeoHash, GMap, GMapCounties, GMapGraph, GMapLayered, GMapPin, GMapPinLine, Graph, Graticule, Layered, Leaflet, Lines, OpenStreet, Pins, GMapHeat, Heat, TopoJSONChoropleth, Layer, ChoroplethStatesHeat } from "@hpcc-js/map";
