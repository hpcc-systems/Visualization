...
## [1.10.1](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.10.0...markdown-it-plugins-v1.10.1) (2026-09-18)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.12.0 to ^3.12.1

## [1.10.0](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.9.2...markdown-it-plugins-v1.10.0) (2026-09-17)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.11.2 to ^3.12.0
  * devDependencies
    * @hpcc-js/vite-plugins bumped from ^1.4.1 to ^1.5.0

## [1.9.2](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.9.1...markdown-it-plugins-v1.9.2) (2026-09-14)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.11.1 to ^3.11.2
  * devDependencies
    * @hpcc-js/vite-plugins bumped from ^1.4.0 to ^1.4.1

## [1.9.1](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.9.0...markdown-it-plugins-v1.9.1) (2026-09-06)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.11.0 to ^3.11.1
  * devDependencies
    * @hpcc-js/vite-plugins bumped from ^1.3.0 to ^1.4.0

## [1.9.0](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.8.0...markdown-it-plugins-v1.9.0) (2026-08-20)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.10.1 to ^3.11.0
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.9.2 to ^3.9.3
  * devDependencies
    * @hpcc-js/esbuild-plugins bumped from ^1.9.6 to ^1.9.7

## [1.6.7](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.6.6...markdown-it-plugins-v1.6.7) (2026-07-22)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.9.1 to ^3.9.2
  * devDependencies
    * @hpcc-js/esbuild-plugins bumped from ^1.9.5 to ^1.9.6

## [1.6.6](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.6.5...markdown-it-plugins-v1.6.6) (2026-07-20)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.9.0 to ^3.9.1
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.8.3 to ^3.8.4
  * devDependencies
    * @hpcc-js/esbuild-plugins bumped from ^1.9.3 to ^1.9.4

## [1.6.3](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.6.2...markdown-it-plugins-v1.6.3) (2026-06-15)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.8.2 to ^3.8.3
  * devDependencies
    * @hpcc-js/esbuild-plugins bumped from ^1.9.2 to ^1.9.3

## [1.6.2](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.6.1...markdown-it-plugins-v1.6.2) (2026-06-01)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.8.1 to ^3.8.2
  * devDependencies
    * @hpcc-js/esbuild-plugins bumped from ^1.9.1 to ^1.9.2

## [1.6.1](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.6.0...markdown-it-plugins-v1.6.1) (2026-05-29)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.8.0 to ^3.8.1
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.7.12 to ^3.7.13
  * devDependencies
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.7.10 to ^3.7.11
  * devDependencies
    * @hpcc-js/esbuild-plugins bumped from ^1.8.8 to ^1.8.9

## [1.5.12](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.5.11...markdown-it-plugins-v1.5.12) (2026-05-01)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.7.9 to ^3.7.10
  * devDependencies
    * @hpcc-js/esbuild-plugins bumped from ^1.8.7 to ^1.8.8

## [1.5.11](https://github.com/hpcc-systems/Visualization/compare/markdown-it-plugins-v1.5.9...markdown-it-plugins-v1.5.11) (2026-04-07)
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.7.8 to ^3.7.9
...
* The following workspace dependencies were updated
  * dependencies
    * @hpcc-js/observablehq-compiler bumped from ^3.7.6 to ^3.7.7
  * devDependencies
