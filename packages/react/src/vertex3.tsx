...
export const Vertex3: React.FunctionComponent<IVertex3> = ({
    ...
    const labelShapeWidth = labelWidth + (textPadding * 2) + (textboxStrokeWidth * 2);
        ...
        annotationArr.push(
            <g class="vertex3-anno" transform={`translate(${annoOffsetX} ${annoOffsetY})`}>
                <Icon
                    ...
                    imageChar={annoText}
                    imageFontFamily={anno.fontFamily}
    ...
    if (annotationMeta.length > 0) {
        fullAnnotationWidth += annotationGutter * (annotationMeta.length - 1);
    }
