...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "../common/HTMLWidget", "amcharts/funnel", "../chart/INDChart"], factory);
    } else {
        root.amcharts_CommonFunnel = factory(root.d3, root.common_HTMLWidget, root.amcharts, root.chart_INDChart);
    }
    ...
    CommonFunnel.prototype.publish("marginRight", null, "number", "Margin (Right)");
    ...
    CommonFunnel.prototype.publish("globalFillAlpha", .3, "number", "Shape Opacity", null, {min:0,max:1,step:0.001,inputType:'range'});
    CommonFunnel.prototype.publish("globalLineAlpha", 1, "number", "Line Opacity", null, {min:0,max:1,step:0.001,inputType:'range'}); 
    CommonFunnel.prototype.publish("globalLineThickness", 2, "number", "Line Thickness", null, {min:0,max:10,step:0.1,inputType:'range'}); 
    ...
    CommonFunnel.prototype.publish("graphFillAlpha", [], "array", "Area Opacity", null, {min:0, max:1,step:0.001,inputType:'range'});
    CommonFunnel.prototype.publish("graphLineAlpha", [], "array", "Area Border Opacity", null, {min:0,max:1,step:0.001,inputType:'range'});
    CommonFunnel.prototype.publish("graphLineThickness", [], "array", "Line Thickness", null, {min:0,max:1,step:0.001,inputType:'range'}); 
    ...
    CommonFunnel.prototype.publish("dataDateFormat", null, "string", "");
