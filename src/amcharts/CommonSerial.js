...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "../common/HTMLWidget", "amcharts/serial", "../chart/INDChart"], factory);
    } else {
        root.amcharts_CommonSerial = factory(root.d3, root.common_HTMLWidget, root.amcharts, root.chart_INDChart);
    }
