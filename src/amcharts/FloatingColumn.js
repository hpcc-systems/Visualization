...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "./CommonSerial", "amcharts/serial", "../chart/INDChart"], factory);
    } else {
        root.amcharts_FloatingColumn = factory(root.d3, root.amcharts_CommonSerial, root.amcharts, root.chart_INDChart);
    }
