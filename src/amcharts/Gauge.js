...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "../common/HTMLWidget", "amcharts/gauge", "../chart/I1DChart"], factory);
    } else {
        root.amcharts_Gauge = factory(root.d3, root.common_HTMLWidget, root.amcharts, root.chart_I1DChart);
    }
    ...
    Gauge.prototype.updateChartOptions = function() {
        ...
        //TODO add margin updown and the if block from the other ones
