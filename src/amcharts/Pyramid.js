...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "./CommonFunnel", "amcharts/funnel", "../chart/I2DChart"], factory);
    } else {
        root.amcharts_Pyramid = factory(root.d3, root.amcharts_CommonFunnel, root.amcharts, root.chart_I2DChart);
    }
