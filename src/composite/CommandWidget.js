...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["d3", "../common/HTMLWidget", "src/layout/Border",  "src/other/Toolbar", "src/other/ButtonAnnotations", "css!./CommandWidget.css"], factory);
    } else {
...
}(this, function (d3, HTMLWidget, Border, Toolbar, ButtonAnnotations) {
            ...
            .rightButtons(
                new ButtonAnnotations()
                    ...
                    .data([
                            ...
                            {
                                icon:"fa-th-large",
                                click:function(){console.log('TH Large btn has been clicked.');}
                            },
                            {
                                icon:"fa-minus",
