...
(function (root, factory) {
    ...
    Bar.prototype.publish("xAxisFontFamily", null, "string", "Horizontal axis text style (Font Name)");
    Bar.prototype.publish("xAxisFontSize", null, "number", "Horizontal axis text style (Font Size)");
    ...
    Bar.prototype.publish("yAxisInversed", false, "boolean", "The direction in which the values along the vertical axis grow. Specify -1 to reverse the order of the values.");
    ...
    Bar.prototype.publish("yAxisFontFamily", null, "string", "Vertical axis text style (Font Name)");
    Bar.prototype.publish("yAxisFontSize", null, "number", "Vertical axis text style (Font Size)");
