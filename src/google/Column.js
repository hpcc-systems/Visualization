...
(function (root, factory) {
    ...
    Column.prototype.publish("axisFontFamily", null, "string", "Horizontal axis text style (Font Name)");
    Column.prototype.publish("axisFontSize", null, "number", "Horizontal axis text style (Font Size)");
    ...
    Column.prototype.publish("xAxisInversed", false, "boolean", "The direction in which the values along the horizontal axis grow.");
    ...
    Column.prototype.publish("yAxisInversed", false, "boolean", "The direction in which the values along the vertical axis grow.");
