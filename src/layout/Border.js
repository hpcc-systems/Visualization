...
(function (root, factory) {
    ...
    Border.prototype.applyLayoutType = function (layoutType) {
        ...
        for(var i in this.content()){
            this.content()[i]._fixedLeft = layoutObj[this.content()[i]._sectionType].left;
            this.content()[i]._fixedTop = layoutObj[this.content()[i]._sectionType].top;
            this.content()[i]._fixedWidth = layoutObj[this.content()[i]._sectionType].width;
            this.content()[i]._fixedHeight = layoutObj[this.content()[i]._sectionType].height;
        }
    };
