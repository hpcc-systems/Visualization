...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        root.map_ChoroplethStatesHeat = factory(root.layout_Layered, root.layout_AbsoluteSurface, root.map_ChoroplethStates, root.other_HeatMap);
    }
    ...
    ChoroplethStatesHeat.prototype.testData = function () {
        var testData = [
