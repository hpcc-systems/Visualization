...
(function (root, factory) {
    ...
    GMap.prototype.update = function (domNode, element) {
        if(this.streetViewStreetAddress()){
            this.showStreetView();
            if(!this.streetViewTargetSelector())return;
        }
    ...
    GMap.prototype.showStreetView = function () {
        var map = this.streetViewTargetSelector() ? new google.maps.Map(document.querySelector(this.streetViewTargetSelector()),{zoom: 5,mapTypeId: google.maps.MapTypeId.ROADMAP}) : this._googleMap;
