...
(function (root, factory) {
    ...
    HTML.prototype.publish("designMode", false, "boolean", "Design Mode", null, { tags: ["Basic"] });
    ...
    HTML.prototype._origDesignMode = HTML.prototype.designMode;
    HTML.prototype.designMode = function (_) {
        var retVal = HTML.prototype._origDesignMode.apply(this, arguments);
        if (arguments.length) {
