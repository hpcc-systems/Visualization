...
(function (root, factory) {
    ...
    Paginator.prototype.enter = function (domNode, element) {
        ...
        this.paginator = this.container.append("ul").attr("class","paginator pagination pagination-sm");
        this.side = this.container.append("div").attr("class","paginator pagination side");
    ...
    Paginator.prototype.update = function (domNode, element) {
        ...
        this.side.select(".currentPageNumber").attr("value",this.pageNumber());
