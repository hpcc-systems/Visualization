    ...
    return {
        Bar: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Bar"], function (DataFactory, Bar) {
                    callback(new Bar()
        ...
        Column: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Column"], function (DataFactory, Column) {
                    callback(new Column()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                    );
        ...
        Combo: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Combo"], function (DataFactory, Combo) {
                    callback(new Combo()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                        .types(["bar", "line", "area"])
            ...
            complex: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Grid", "src/c3chart/Combo"], function (DataFactory, Grid, Combo) {
                    var grid = new Grid()
        ...
        Donut: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Donut"], function (DataFactory, Donut) {
                    callback(new Donut()
        ...
        Scatter: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Scatter"], function (DataFactory, Scatter) {
        ...
        Line: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Line"], function (DataFactory, Line) {
                    callback(new Line()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                    );
        ...
        Area: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Area"], function (DataFactory, Area) {
                    callback(new Area()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                    );
        ...
        Pie: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Pie"], function (DataFactory, Pie) {
                    callback(new Pie()
                        .columns(DataFactory.TwoD.subjects.columns)
                        .data(DataFactory.TwoD.subjects.data)
                    );
        ...
        Step: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Step"], function (DataFactory, Step) {
                    callback(new Step()
                        .columns(DataFactory.ND.subjects.columns)
                        .data(DataFactory.ND.subjects.data)
                    );
        ...
        Gauge: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/c3chart/Gauge"], function (DataFactory, Gauge) {
                    callback(new Gauge()
