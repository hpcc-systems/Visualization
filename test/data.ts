...
export const ordinalCandleOHLC = {
    simple: {
        columns: ["Region", "May", "June", "July"],
        data: [
            ["Munster", [1, 11], [2, 14], [8, 18]],
...
export const Sample = {
    ...
    StockMarket: {
        ...
        data: [["2010-09-30", "10835.96", "10960.99", "10732.27", "10788.05", "4284160000", "10788.05"],
