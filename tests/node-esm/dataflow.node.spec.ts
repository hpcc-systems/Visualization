// Test ESM imports for @hpcc-js/dataflow package
import { describe, it, expect } from "vitest";

describe("@hpcc-js/dataflow ESM compatibility", () => {
    ...
    it("should export activity types", async () => {
        ...
        expect(isSource).toBeDefined(); expect(typeof isSource).toBe("function");
    });
    ...
    it("should work with basic pipe operation", async () => {
        const { pipe, map, filter } = await import("@hpcc-js/dataflow");
    ...
    it("should work with sort activity", async () => {
        const { sort } = await import("@hpcc-js/dataflow");
