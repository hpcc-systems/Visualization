...
(function (factory) {
    ...
    var TSModule = /** @class */ (function (_super) {
        ...
        function TSModule(folderPath, tdNode) {
            ...
            if (tdNode.children) {
                tdNode.children.filter(function (cls) { return cls.kindString === "Class"; }).forEach(function (cls) {
                    _this._classes[cls.name] = new TSClass(folderPath, cls);
                });
            }
            return _this;
        }
    ...
    var TSClass = /** @class */ (function (_super) {
        ...
        function TSClass(folderPath, tdNode) {
            var _this = _super.call(this, tdNode) || this;
    ...
    var Meta = /** @class */ (function () {
        function Meta(folderPath, filePath, metaJson) {
            var _this = this;
            this.modules = {};
            this._classes = {};
            if (metaJson.children) {
                metaJson.children.forEach(function (mod) {
                    _this.modules[mod.name] = new TSModule(folderPath, mod);
