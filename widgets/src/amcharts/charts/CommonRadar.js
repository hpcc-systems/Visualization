...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        root.CommonRadar = factory(root.d3, root.HTMLWidget, root.amcharts, root.INDChart);
    }
    ...
    CommonRadar.prototype.publish("marginLeft", 0, "number", "Margin (Left)");
    CommonRadar.prototype.publish("marginRight", 0, "number", "Margin (Right)");
    CommonRadar.prototype.publish("marginTop", 0, "number", "Margin (Top)");
    CommonRadar.prototype.publish("marginBottom", 0, "number", "Margin (Bottom)");
    ...
    CommonRadar.prototype.publish("globalTooltipText","[[category]]([[title]]): [[value]]", "string", "Tooltip Text");
    CommonRadar.prototype.publish("graphTooltipText",["[[category]]([[title]]): [[value]]"], "array", "Tooltip Text");
    ...
    CommonRadar.prototype.publish("showGuides", false, "boolean", "Show Guides");
    CommonRadar.prototype.publish("guides", [["min",20,true,true,"#ee00ff"],["med",40,true,true,"#ccccff"],["max",60,true,true,"#ff00cc"]], "array", "Area Guides");
    
    CommonRadar.prototype.publish("dataDateFormat", null, "string", "Show Guides");
