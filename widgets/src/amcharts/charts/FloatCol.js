...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        root.FloatCol = factory(root.d3, root.CommonSerial, root.amcharts, root.INDChart);
    }
    ...
    FloatCol.prototype.publish("globalTooltipText","[[category]] Open:[[open]] Close:[[close]]", "string", "Tooltip Text");
    FloatCol.prototype.publish("graphTooltipText",[], "array", "Tooltip Text Array");
