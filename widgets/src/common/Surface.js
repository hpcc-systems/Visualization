(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define(["./D3Widget", "./Icon", "./Shape", "./Text", "./FAChar", "d3/d3"], factory);
    } else {
        root.Graph = factory(root.D3Widget, root.Icon, root.Shape, root.Text, root.FAChar, root.d3);
    }
}(this, function (D3Widget, Icon, Shape, Text, FAChar, d3) {
    function Surface() {
        D3Widget.call(this);
