...
(function (root, factory) {
    ...
    dyChart.prototype.publish("color", [,,[]], "array", '{type:"custom-html-color"}');
    dyChart.prototype.publish("colorValue", [,,[]], "array", '{type:"custom-number"}');
    ...
    dyChart.prototype.publish("drawAxis", [,{'x':true,'y':true,'y2':false},], "array", '{type:"custom-boolean"}');
    dyChart.prototype.publish("includeZero", false, "boolean", "");
    dyChart.prototype.publish("independentTicks", [,{'y':true,'y2':false},], "array", '{type:"custom-boolean"}'); // only for y's
    dyChart.prototype.publish("gridLineWidth", [,{'x':0.3,'y':0.3},], "array", '{type:"custom-number"}');
    dyChart.prototype.publish("labelsUTC", false, "boolean", "");
    dyChart.prototype.publish("labelsKMB", [false,{'y':false,'y2':false},], "array", '{type:"custom-boolean"}');
    dyChart.prototype.publish("labelsKMG2", [false,{'y':false,'y2':false},], "array", '{type:"custom-boolean"}');
    dyChart.prototype.publish("logscale", false, "boolean", "");
    dyChart.prototype.publish("panEdgeFraction", null, "number", "");
    dyChart.prototype.publish("pixelsPerLabel", [,{'x':70,'y':30},],"array", '{type:"custom-number"}'); // Default: 70 (x-axis) or 30 (y-axes)
    ...
    dyChart.prototype.publish("strokeBorderColor", ["#FFFFFF",{},{}],"array", '{type:"custom-html-color"}');
    dyChart.prototype.publish("strokeBorderWidth", [null,{},{}],"array", '{type:"custom-number"}'); // make an inject
    dyChart.prototype.publish("strokePattern", [[],{},{}],"array", '{type:"custom-array"}'); // make an inject or blank array?
    dyChart.prototype.publish("strokeWidth", [1.0,{},{}],"array", '{type:"custom-number"}');
    ...
    dyChart.prototype.publish("drawGrid", [,{'y':true,'x':true,'y2':false},],"array", '{type:"custom-boolean"}');
    dyChart.prototype.publish("gridLineColor", ["#808080",{'x':"#808080",'y':"#808080"},],"array", '{type:"custom-html-color"}');
    ...
    dyChart.prototype.publish("highlightCircleSize", [3,{},{}],"array", '{type:"custom-number"}');
